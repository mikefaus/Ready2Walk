  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `sessions_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `sessionDate` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '73ccd4f5f2d794cbd733ce6833305294')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsSessionsTable = new HashMap<String, TableInfo.Column>(2);
        _columnsSessionsTable.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSessionsTable.put("sessionDate", new TableInfo.Column("sessionDate", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoSessionsTable.equals(_existingSessionsTable)) {
          return new RoomOpenHelper.ValidationResult(false, "sessions_table(com.capstone.ready2walk.Database.Sessions).\n"
                  + " Expected:\n" + _infoSessionsTable + "\n"
                  + " Found:\n" + _existingSessionsTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "73ccd4f5f2d794cbd733ce6833305294", "c743e7a081b748f3870147971d4aa6cd");
